...
func main() {
	...
	// 2. Overwrite ai/aiservice/client.go
	aiClientContent := `// Code generated by Kitex v1.20.0. DO NOT EDIT.
...
`
	...
	// 3. Overwrite ai/aiservice/server.go
	aiServerContent := `// Code generated by Kitex v1.20.0. DO NOT EDIT.
package aiservice
...
`
	os.WriteFile("kitex_gen/ai/aiservice/server.go", []byte(aiServerContent), 0644)

	// 4. Overwrite stock/stockservice/client.go
...
`
	...
	// 5. Overwrite stock/stockservice/server.go
